...
%	    disp(['Size mask ' num2str(size(param.mask_nonan))])
%           disp(['Numel mask ' num2str(numel(find(param.mask_nonan)))])
%	    disp(['Size I_sig ' num2str(size(I_sig))])
%	    disp(['Size SignInnov ' num2str(size(SignInnov))])
%           disp(['Numel in I_sig ' num2str(numel(iI_sig:iI_sig+nSignInnov-1))])
